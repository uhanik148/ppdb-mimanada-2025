...
import { FaMapMarkerAlt, FaPhone, FaEnvelope, FaFacebook, FaInstagram, FaWhatsapp, FaTiktok, FaYoutube } from 'react-icons/fa';
			...
			<div className='bg-gray-900 text-gray-300 py-10'>
				<div className='container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10'>
					...
					<div>
						...
						<div className='space-y-3'>
							<a
								href='https://www.facebook.com/profile.php?id=61572282390905'
								className='flex items-center bg-gray-700 px-4 py-2 rounded-lg shadow hover:text-white'
							>
								<FaFacebook className='text-blue-600 mr-3' /> Facebook
							</a>
							<a
								href='https://www.instagram.com/mimaarifnailulhuda'
								className='flex items-center bg-gray-700 px-4 py-2 rounded-lg shadow hover:text-white'
							>
								<FaInstagram className='text-pink-500 mr-3' /> Instagram
							</a>
							<a
								href='https://www.tiktok.com/@mi.manada.garum'
								className='flex items-center bg-gray-700 px-4 py-2 rounded-lg shadow hover:text-white'
							>
								<FaTiktok className='text-white mr-3' /> TikTok
							</a>
							<a
								href='https://youtube.com/@nailulhuda7150'
								className='flex items-center bg-gray-700 px-4 py-2 rounded-lg shadow hover:text-white'
							>
