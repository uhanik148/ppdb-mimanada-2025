...
export default function Step2Form({ nextStep, prevStep, formData, setFormData }) {
	...
	return (
		...
		>
			...
			<h2 style={sectionTitle}>Sekolah Yang Akan Didaftari</h2>

			<div style={formGroup}>
				<label htmlFor='tipeSekolah'>Pilih Tipe Sekolah</label>
				<select
					id='tipeSekolah'
					name='tipeSekolah'
				...
				>
					...
					<option value='Sekolah Saja'>Sekolah Saja</option>
					<option value='Sekolah + Pondok'>Sekolah + Pondok</option>
				</select>
			</div>

			<hr style={{ margin: '1rem 0', border: '1px solid #eee', width: '100%' }} />
