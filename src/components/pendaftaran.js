...
export default function Pendaftaran() {
	...
	return (
		<section
			id='pendaftaran'
			className={`py-16 px-6 bg-gradient-to-b from-gray-50 to-gray-100 transition-opacity duration-1000 ${fadeIn ? 'opacity-100' : 'opacity-0'}`}
		>
			<div className='max-w-6xl mx-auto text-center'>
				...
				<p className='text-lg text-gray-600 max-w-2xl mx-auto'>
					Siap menjadi bagian dari keluarga besar <span className='font-semibold text-green-800'>MI MAA'RIF NAILUL HUDA</span>? Yuk, ikuti langkah-langkah pendaftarannya berikut ini!
				</p>
			</div>
					...
					>
						...
						>
							<path
								...
								strokeLinejoin='round'
								strokeWidth='2'
								d='M9 12h6m-6 4h6M5 5h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2z'
							/>
						</svg>
						Petunjuk Pengisian
					</a>
