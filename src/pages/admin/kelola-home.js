    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input name="heroTitle" value={data.heroTitle} onChange={handleChange} className="input" />
        </div>
        <div>
          <label className="block font-semibold">Subjudul Hero</label>
          <input name="heroSubtitle" value={data.heroSubtitle} onChange={handleChange} className="input" />
        </div>
        <div>
          <label className="block font-semibold">Gambar Hero (URL)</label>
          <input name="heroImage" value={data.heroImage} onChange={handleChange} className="input" />
        </div>

        {/* Tentang Kami */}
        <div>
          <label className="block font-semibold">Judul Tentang</label>
          <input name="aboutTitle" value={data.aboutTitle} onChange={handleChange} className="input" />
        </div>
        <div>
          <label className="block font-semibold">Deskripsi Tentang</label>
          <textarea name="aboutDescription" value={data.aboutDescription} onChange={handleChange} className="input h-24" />
        </div>
